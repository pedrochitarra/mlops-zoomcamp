...
from evidently.metrics import (ColumnDriftMetric, DatasetDriftMetric,
							   ...
							   ColumnQuantileMetric, DatasetSummaryMetric)
...
num_features = ['passenger_count', 'trip_distance',
...
def calculate_metrics_postgresql(curr, i):
	...
	curr.execute(
		...
		num_drifted_columns, share_missing_values, fare_amount_quantile) values
		(%s, %s, %s, %s, %s)""",
		(begin + datetime.timedelta(i), prediction_drift,
		 num_drifted_columns, share_missing_values, fare_amount_quantile)
	)
